...
public class PreMockJUnit4ClassRunner extends BlockJUnit4ClassRunner {
    ...
    private static final ClassLoader classLoader = new MockFinalClassLoader(
    ...
    public PreMockJUnit4ClassRunner(Class<?> unitTestClass)
        ...
        MockFinalClassLoader.setClasses(getClassesToAlter(unitTestClass));
    ...
    private Set<String> getClassesToAlter(Class<?> unitTestClass) {
        ...
        MockFinal annotation = unitTestClass.getAnnotation(MockFinal.class);
